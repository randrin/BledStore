            ...
            <tr>
              ...
              <td>${
                order.paidAt
                  ...
                  : `<span class="error font-bold">No</span>`}</td>
          <td>${
            order.deliveryAt
              ...
              <button id="${
                order._id
              }" class="edit-order-button"><i class="fa fa-edit success"></i> Edit</button>
              <button id="${
                order._id
              }" class="delete-order-button"><i class="fa fa-trash error"></i> Delete</button>
              </td>
            </tr>
            `
              )
