        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>${
                order.paidAt
                  ? `<span class="success font-bold">${moment(order.paidAt).format('DD/MM/YYYY HH:mm:s')}</span>`
                  : `<span class="error font-bold">No</span>`}
              </td>
              <td>${
                order.deliveredAt
                  ? `<span class="success font-bold">${moment(order.deliveredAt).format('DD/MM/YYYY')}</span>`
                  : `<span class="error font-bold">No</span>`}
              </td>
              <td>
