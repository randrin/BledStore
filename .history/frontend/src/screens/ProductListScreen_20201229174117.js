        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>${product.brand}</td>
              <td>
              <button id="${product._id}" class="edit-product-button"><i class="fa fa-edit"></i> Edit</button>
              <button id="${product._id}" class="delete-product-button"><i class="fa fa-edit">Delete</button>
              </td>
            </tr>
            `
              )
