    ...
    <hr/>
      <table>
        ...
        <tr>
          ...
          <td>${order.paidAt ? `<span class="success font-bold">${order.paidAt }</span>`: `<span class="error font-bold">No</span>`}</td>
          <td>${order.deliveryAt ? `<span class="success font-bold">${order.deliveryAt }</span>`: `<span class="error font-bold">No</span>`}</td>
